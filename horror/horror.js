...
let response = "";
let horrorTitle;
let horrorBookBackground;

function preload() {
  bot.loadFile("horror.txt").then(loaded).catch(error);

  horrorTitle = loadImage("horrorTitle.png");
  horrorBookBackground = loadImage("horrorBookBackground.png")
}
function setup() {
...
function draw() {
  ...
  image(horrorTitle, width/2-230, height/2-580, 450,300);
  image(horrorBookBackground, width/2-550, height/2-410, 1090, 1090);
