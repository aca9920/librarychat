...
let romanceTitle;
let romanceBookBackground;



function preload() {
  bot.loadFile("romance.txt").then(loaded).catch(error);


  romanceTitle = loadImage("romanceTitle.png");
  romanceBookBackground = loadImage("romanceBookBackground.png")
}
function setup() {
...
function draw() {
  ...
  image(romanceTitle, width/2-230, height/2-590, 450,300);
  image(romanceBookBackground, width/2-550, height/2-410, 1090, 1090);
